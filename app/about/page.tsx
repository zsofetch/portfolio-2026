...
const certificationsData = [
  {
    ...
    description: "I took an Intermediate Docker course and learned the basics of containerization, virtualization, and using Kubernetes bla bla bla.",
  },
  {
    id: 2,
    title: "Introduction to Containerization and Virtualization",
    image: "/cert-candv.png",
    description: "Completed comprehensive labs focusing on advanced backup script scheduling, core system administration, and strict switch port channel configurations.",
  },
  {
    id: 3,
    title: "Research, Development, Extension, and Publications Office (RDEPO) Orientation",
    image: "/cert-rdepo.png",
    description: "Mastered cross-platform application architecture, building functional interfaces utilizing C# and .NET MAUI with integrated Supabase cloud databases.",
  },
  {
    id: 4,
        ...
        <div className="w-full max-w-6xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative w-full flex flex-col items-center">
            ...
            <div className="relative w-full aspect-[16/10] bg-white rounded-lg shadow-2xl overflow-hidden group">
              ...
              >
                <img src="/arrow-right.png" alt="Previous" className="w-12 h-12" />
              </button>
            </div>
